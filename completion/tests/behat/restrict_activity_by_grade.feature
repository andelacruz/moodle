...
Feature: Restrict activity availability through grade conditions
  ...
  Scenario: Show activity greyed-out to students when grade condition is not satisfied
    ...
    And the following "activities" exist:
      | course | activity | section | idnumber         | name             | assignsubmission_onlinetext_enabled | assignsubmission_file_enabled | submissiondrafts | intro                                                            | content            |
      | C1     | assign   | 1       | Grade assignment | Grade assignment | 1                                   | 0                             | 0                |                                                                  |                    |
      | C1     | page     | 2       | Grade page       | Test page name   |                                     |                               |                  | Restricted page, till grades in Grade assignment is at least 20% | Test page contents |
