...
Feature: Forum posts can be replied to in private
  ...
  Background:
    ...
    And the following "mod_forum > posts" exist:
      ...
      | teacher1 | Answers to the homework   | How about you and I have a meeting after class about plagiarism? | How about you and I have a meeting after class about plagiarism? | 1              |
