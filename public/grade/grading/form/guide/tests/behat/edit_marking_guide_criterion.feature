...
Feature: Marking guide criterion can be edited and replaced
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | course | name     | advancedgradingmethod_submissions | assignsubmission_onlinetext_enabled | assignsubmission_file_enabled |
      | assign   | C1     | Assign 1 | guide                             | 1                                   | 0                             |
  ...
  Scenario: Marking guide criterion can be modified
    # TODO: Remove when PHP warnings are resolved
    # Added to hide any PHP warnings displayed when updating the marking guide in order to proceed with test smoothly.
